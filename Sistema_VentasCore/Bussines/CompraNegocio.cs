...
namespace Sistema_VentasCore.Bussines
{
    public class CompraNegocio
    {
        ...
        public static bool EsCantidadValida(string cantidad)
        {
            return Validaciones.EsMayorACero(cantidad);
        }
        public static (decimal resultado,bool valido) EsDescuentoValido(string descuento){
            decimal desc=-1;
            bool valido=false;
        ...
        public static bool CantidadEnRango(string cantidad, int cantidadStock)
        {
            try
            {
        ...
        public static int CalcularStock(string cantidad, int stock)
        {
            int cant;
            int nvoStock;
     ...
     /// <returns> bool para saber si hay productos con existencia minima, string para saber cuales son</returns>
      public static (bool hay, string mnj)AlertaExistencia(List<Producto> productos)
        {
